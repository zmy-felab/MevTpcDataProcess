...
std::string noise_data_dictionary = work_dictionary + "noise_data_range_0_gain_16/";
...
{	
	...
	// gain calibration
	raw_data_read_1v0(work_dictionary + "gain_cali_data_range_0_gain_31/", "ADC_code_correction", correct_cali_dictionary); // option = "ADC_code_calibration" or "ADC_code_correction"
	info_calculate(work_dictionary + "gain_cali_data_range_0_gain_31/", "gain_cali", ""); // option = "gain_cali" or "info_calculate"
	raw_data_read_1v0(work_dictionary + "gain_cali_data_range_1_gain_0/", "ADC_code_correction", correct_cali_dictionary); // option = "ADC_code_calibration" or "ADC_code_correction"
	info_calculate(work_dictionary + "gain_cali_data_range_1_gain_0/", "gain_cali", ""); // option = "gain_cali" or "info_calculate"
	...
	info_calculate(work_dictionary + "gain_cali_data_range_1_gain_16/", "gain_cali", ""); // option = "gain_cali" or "info_calculate"
	...
	info_calculate(work_dictionary + "gain_cali_data_range_1_gain_31/", "gain_cali", ""); // option = "gain_cali" or "info_calculate"
	...
	info_calculate(work_dictionary + "gain_cali_data_range_3_gain_0/", "gain_cali", ""); // option = "gain_cali" or "info_calculate"
	...
	info_calculate(work_dictionary + "gain_cali_data_range_3_gain_16/", "gain_cali", ""); // option = "gain_cali" or "info_calculate"
	...
	info_calculate(work_dictionary + "gain_cali_data_range_3_gain_31/", "gain_cali", ""); // option = "gain_cali" or "info_calculate"
	...
	// get_code_spectrum(test_data_dictionary);
